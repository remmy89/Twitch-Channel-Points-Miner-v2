...
twitch_miner = TwitchChannelPointsMiner(
    ...
    password=os.getenv("pass"),           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        telegram=None,
        discord=Discord(
            webhook_api=os.getenv("webhook"),  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE, Events.BET_LOSE,
        Events.CHAT_MENTION, Events.BET_WIN, Events.GAIN_FOR_RAID,
        Events.GAIN_FOR_CLAIM, Events.GAIN_FOR_WATCH, Events.BET_REFUND,
        Events.BET_GENERAL, Events.BET_FILTERS, Events.BET_FAILED,
        Events.BET_START, Events.BONUS_CLAIM, Events.MOMENT_CLAIM,
        Events.JOIN_RAID, Events.DROP_CLAIM, Events.DROP_STATUS],       # Only these events will be sent to the chat
        )
    ),
